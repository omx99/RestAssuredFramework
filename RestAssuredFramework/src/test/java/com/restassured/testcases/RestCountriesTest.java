...
public class RestCountriesTest extends BaseTest{
	...
	@Test
	public void getCountryDetailsTest() throws IOException {
		/*
		...
		.get("https://restcountries.eu/rest/v2/name/Taiwan");
		...
		Assert.assertEquals(response.jsonPath().get("[0].capital"), "Taipei");
